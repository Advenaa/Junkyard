import type { SummaryRow, EventChainRow, UnusualActivityOverview, EntityFirstMoverRow } from '../db/queries.js';
...
export function buildFlashUserMessage(summaries: ScoredSummary[], correlated: CorrelatedEntity[]): string {
  const parts: string[] = [];
